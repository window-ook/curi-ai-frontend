...
export const ActivityMethod = () => {
  ...
  return (
    <div className="w-full flex flex-col space-y-2">
      <h2 className="text-subtitle font-bold custom-black-900">활동 방식 선택</h2>
      ...
      <div className="flex gap-3">
        <button
          ...
          className={`flex-1 px-5 py-4 rounded-lg text-xl font-semibold transition-colors cursor-pointer ${selectedMethod === 'online'
            ...
            : 'bg-white border border-custom-gray-200 text-custom-black-900 hover:bg-custom-gray-100'
            }`}
        >
          온라인
        </button>
